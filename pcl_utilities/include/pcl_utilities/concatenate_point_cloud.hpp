 ...
 *
 * @details Given an array of PointCloud2 messages, concatenate into a single PointCloud2
 * message. All frame_id's must be the same for this work.
 *
 ...
 * @throw std::runtime_error if at least one of the frame_ids is different
 */
